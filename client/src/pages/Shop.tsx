              ...
              <Grid item xs={6} sm={4} md={3}>
                ...
                <div className="shop-product-item-container">
                  <div className="shop-product-item-img-wrapper">
                    <img className= "shop-product-img-hover" loading="lazy" src={`${"./assets/" + item.imgMainSrc[1]}`}  alt={item.name} width="auto" height="auto"/>
                    <img className= "shop-product-img-main" loading="lazy" src={`${"./assets/" + item.imgMainSrc[0]}`}  alt={item.name + " hover"} width="auto" height="auto"/>
                  </div>
